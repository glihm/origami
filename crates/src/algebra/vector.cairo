...
impl VectorImpl<
    T, +Mul<T>, +core::ops::AddAssign<T, T>, +Zeroable<T>, +Copy<T>, +Drop<T>,
> of VectorTrait<T> {
    fn new(data: Span<T>) -> Vector<T> {
        Vector { data }
    }
...
impl VectorAdd<
    T, +Mul<T>, +core::ops::AddAssign<T, T>, +Add<T>, +Zeroable<T>, +Copy<T>, +Drop<T>,
> of Add<Vector<T>> {
...
impl VectorSub<
    T, +Mul<T>, +core::ops::AddAssign<T, T>, +Sub<T>, +Zeroable<T>, +Copy<T>, +Drop<T>,
> of Sub<Vector<T>> {
